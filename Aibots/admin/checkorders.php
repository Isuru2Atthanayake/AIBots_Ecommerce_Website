...
<html>
	...
	<div class="header">
        ...
        <form action="checkorders.php" method="post" class="content">
		...
		<div class="input-group">
		 ...
		 <div class="input-group">
            ...
            <div class="input-group">
                ...
                <input type="submit" class="btn" name="search" value="Search Customer"><br><br>
            </div>
				...
				<a href="admincon2.php" class="btn">Back to Admin pannel</a>
